...
import type { CreateUserApiKeyRequest, GetUserApiKey200Response, ListUserApiKeys200Response } from '../models/index';
import {
...
export class ApiKeysApi extends runtime.BaseAPI {
  ...
  async createApiKey(
    ...
    const response = await this.createApiKeyRaw({ createUserApiKeyRequest: createUserApiKeyRequest }, initOverrides);
   ...
   * Delete API Key
   */
  async deleteApiKeyRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Delete API Key
   */
  async deleteApiKey(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
    await this.deleteApiKeyRaw(initOverrides);
  }
   ...
   * Get API Key
   */
  async getApiKeyRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetUserApiKey200Response>> {
    const queryParameters: any = {};
   ...
   * Get API Key
   */
  async getApiKey(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetUserApiKey200Response> {
    const response = await this.getApiKeyRaw(initOverrides);
    return await response.value();
  }
   ...
   * List API Keys
   */
  async listApiKeys(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListUserApiKeys200Response> {
