...
import type { ListMetalPlans200Response, ListPlans200Response } from '../models/index';
import {
  ListMetalPlans200ResponseFromJSON,
  ListMetalPlans200ResponseToJSON,
  ListPlans200ResponseFromJSON,
  ListPlans200ResponseToJSON,
} from '../models/index';

export interface ListMetalPlansRequest {
  perPage?: string;
  cursor?: string;
}
...
export class PlansApi extends runtime.BaseAPI {
   ...
   */
  async listMetalPlansRaw(
    requestParameters: ListMetalPlansRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ListMetalPlans200Response>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) => ListMetalPlans200ResponseFromJSON(jsonValue));
  }
   ...
   * List Bare Metal Plans
   */
  async listMetalPlans(
    perPage?: string,
    cursor?: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ListMetalPlans200Response> {
    const response = await this.listMetalPlansRaw({ perPage: perPage, cursor: cursor }, initOverrides);
  ...
  async listPlansRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ListPlans200Response>> {
    const queryParameters: any = {};
  ...
  async listPlans(
    ...
    os?: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ListPlans200Response> {
    const response = await this.listPlansRaw({ type: type, perPage: perPage, cursor: cursor, os: os }, initOverrides);
    return await response.value();
  }
}
