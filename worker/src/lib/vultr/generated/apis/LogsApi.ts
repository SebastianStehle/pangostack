...
import type { ListLogs200Response } from '../models/index';
import { ListLogs200ResponseFromJSON, ListLogs200ResponseToJSON } from '../models/index';
...
export class LogsApi extends runtime.BaseAPI {
  ...
  ): Promise<runtime.ApiResponse<ListLogs200Response>> {
  ...
  async listLogs(
    ...
    resourceId?: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ListLogs200Response> {
    const response = await this.listLogsRaw(
      { startTime: startTime, endTime: endTime, logLevel: logLevel, resourceType: resourceType, resourceId: resourceId },
      initOverrides,
    );
