 ...
 */
export interface InstanceGet {
  /**
   * A unique ID for the VPS Instance.
   * @type {string}
   * @memberof InstanceGet
   */
  id?: string;
  /**
...
/**
 * Check if a given object implements the InstanceGet interface.
 */
export function instanceOfInstanceGet(value: object): value is InstanceGet {
  return true;
}

export function InstanceGetFromJSON(json: any): InstanceGet {
  return InstanceGetFromJSONTyped(json, false);
}

export function InstanceGetFromJSONTyped(json: any, ignoreDiscriminator: boolean): InstanceGet {
  if (json == null) {
    return json;
  }
  return {
...
export function InstanceGetToJSON(json: any): InstanceGet {
  return InstanceGetToJSONTyped(json, false);
}

export function InstanceGetToJSONTyped(value?: InstanceGet | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
