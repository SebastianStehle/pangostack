 ...
 * @export
 * @interface UploadendpointInputs
 */
export interface UploadendpointInputs {
  /**
   * The access control list rule assigned to requst.  Include this in the upload request from data
   * @type {string}
   * @memberof UploadendpointInputs
   */
  acl?: string;
  /**
...
/**
 * Check if a given object implements the UploadendpointInputs interface.
 */
export function instanceOfUploadendpointInputs(value: object): value is UploadendpointInputs {
  return true;
}

export function UploadendpointInputsFromJSON(json: any): UploadendpointInputs {
  return UploadendpointInputsFromJSONTyped(json, false);
}

export function UploadendpointInputsFromJSONTyped(json: any, ignoreDiscriminator: boolean): UploadendpointInputs {
  if (json == null) {
    return json;
  }
  return {
...
export function UploadendpointInputsToJSON(json: any): UploadendpointInputs {
  return UploadendpointInputsToJSONTyped(json, false);
}

export function UploadendpointInputsToJSONTyped(value?: UploadendpointInputs | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
