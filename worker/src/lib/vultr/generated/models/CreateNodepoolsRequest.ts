 ...
 *
 * @export
 * @interface CreateNodepoolsRequest
 */
export interface CreateNodepoolsRequest {
  /**
   * Number of instances in this nodepool
   * @type {number}
   * @memberof CreateNodepoolsRequest
   */
  nodeQuantity: number;
  /**
...
/**
 * Check if a given object implements the CreateNodepoolsRequest interface.
 */
export function instanceOfCreateNodepoolsRequest(value: object): value is CreateNodepoolsRequest {
...
export function CreateNodepoolsRequestFromJSON(json: any): CreateNodepoolsRequest {
  return CreateNodepoolsRequestFromJSONTyped(json, false);
}

export function CreateNodepoolsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateNodepoolsRequest {
  if (json == null) {
    return json;
  }
  return {
...
export function CreateNodepoolsRequestToJSON(json: any): CreateNodepoolsRequest {
  return CreateNodepoolsRequestToJSONTyped(json, false);
}

export function CreateNodepoolsRequestToJSONTyped(value?: CreateNodepoolsRequest | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
