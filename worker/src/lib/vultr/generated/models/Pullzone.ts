...
export interface Pullzone {
   ...
   * @memberof Pullzone
   */
  originScheme?: PullzoneOriginSchemeEnum;
  /**
 ...
 * @export
 */
export const PullzoneOriginSchemeEnum = {
  Http: 'http',
  Https: 'https',
} as const;
export type PullzoneOriginSchemeEnum = (typeof PullzoneOriginSchemeEnum)[keyof typeof PullzoneOriginSchemeEnum];

/**
 * Check if a given object implements the Pullzone interface.
 */
export function instanceOfPullzone(value: object): value is Pullzone {
  return true;
}

export function PullzoneFromJSON(json: any): Pullzone {
  return PullzoneFromJSONTyped(json, false);
}

export function PullzoneFromJSONTyped(json: any, ignoreDiscriminator: boolean): Pullzone {
  if (json == null) {
    return json;
  }
  return {
    ...
    originScheme: json['origin_scheme'] == null ? undefined : json['origin_scheme'],
    originDomain: json['origin_domain'] == null ? undefined : json['origin_domain'],
    ...
    lastPurge: json['last_purge'] == null ? undefined : json['last_purge'],
...
export function PullzoneToJSON(json: any): Pullzone {
  return PullzoneToJSONTyped(json, false);
}

export function PullzoneToJSONTyped(value?: Pullzone | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
