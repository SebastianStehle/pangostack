...
import type { VfsRegion } from './VfsRegion';
import { VfsRegionFromJSON, VfsRegionFromJSONTyped, VfsRegionToJSON, VfsRegionToJSONTyped } from './VfsRegion';
...
export interface ListRegions200Response {
  /**
   *
   * @type {Array<VfsRegion>}
   * @memberof ListRegions200Response
   */
  regions?: Array<VfsRegion>;
}
...
export function ListRegions200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListRegions200Response {
  ...
  return {
    regions: json['regions'] == null ? undefined : (json['regions'] as Array<any>).map(VfsRegionFromJSON),
  };
}
...
export function ListRegions200ResponseToJSONTyped(value?: ListRegions200Response | null, ignoreDiscriminator: boolean = false): any {
  ...
  return {
    regions: value['regions'] == null ? undefined : (value['regions'] as Array<any>).map(VfsRegionToJSON),
  };
}
