 ...
 */
export function instanceOfFirewallGroup(value: object): value is FirewallGroup {
  return true;
}
...
export function FirewallGroupFromJSONTyped(json: any, ignoreDiscriminator: boolean): FirewallGroup {
  ...
  return {
    ...
    dateModified: json['date_modified'] == null ? undefined : json['date_modified'],
    instanceCount: json['instance_count'] == null ? undefined : json['instance_count'],
    ruleCount: json['rule_count'] == null ? undefined : json['rule_count'],
    maxRuleCount: json['max_rule_count'] == null ? undefined : json['max_rule_count'],
  };
}

export function FirewallGroupToJSON(json: any): FirewallGroup {
  return FirewallGroupToJSONTyped(json, false);
}

export function FirewallGroupToJSONTyped(value?: FirewallGroup | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
  ...
  return {
    ...
    max_rule_count: value['maxRuleCount'],
  };
}
