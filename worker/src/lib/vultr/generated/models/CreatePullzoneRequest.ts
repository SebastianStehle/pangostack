 ...
 *
 * @export
 * @interface CreatePullzoneRequest
 */
export interface CreatePullzoneRequest {
  /**
   * The user-supplied label.
   * @type {string}
   * @memberof CreatePullzoneRequest
   */
  label: string;
  /**
   ...
   * @memberof CreatePullzoneRequest
   */
  originScheme: CreatePullzoneRequestOriginSchemeEnum;
  /**
 ...
 * @export
 */
export const CreatePullzoneRequestOriginSchemeEnum = {
  Http: 'http',
  Https: 'https',
} as const;
export type CreatePullzoneRequestOriginSchemeEnum =
  (typeof CreatePullzoneRequestOriginSchemeEnum)[keyof typeof CreatePullzoneRequestOriginSchemeEnum];

/**
 * Check if a given object implements the CreatePullzoneRequest interface.
 */
export function instanceOfCreatePullzoneRequest(value: object): value is CreatePullzoneRequest {
  if (!('label' in value) || value['label'] === undefined) return false;
  if (!('originScheme' in value) || value['originScheme'] === undefined) return false;
  if (!('originDomain' in value) || value['originDomain'] === undefined) return false;
  return true;
}

export function CreatePullzoneRequestFromJSON(json: any): CreatePullzoneRequest {
  return CreatePullzoneRequestFromJSONTyped(json, false);
}

export function CreatePullzoneRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreatePullzoneRequest {
  if (json == null) {
    return json;
  }
  return {
    label: json['label'],
    originScheme: json['origin_scheme'],
    originDomain: json['origin_domain'],
    vanityDomain: json['vanity_domain'] == null ? undefined : json['vanity_domain'],
    sslCert: json['ssl_cert'] == null ? undefined : json['ssl_cert'],
    sslCertKey: json['ssl_cert_key'] == null ? undefined : json['ssl_cert_key'],
...
export function CreatePullzoneRequestToJSON(json: any): CreatePullzoneRequest {
  return CreatePullzoneRequestToJSONTyped(json, false);
}

export function CreatePullzoneRequestToJSONTyped(value?: CreatePullzoneRequest | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
  ...
  return {
    label: value['label'],
    origin_scheme: value['originScheme'],
    origin_domain: value['originDomain'],
    vanity_domain: value['vanityDomain'],
    ssl_cert: value['sslCert'],
    ssl_cert_key: value['sslCertKey'],
    cors: value['cors'],
    gzip: value['gzip'],
