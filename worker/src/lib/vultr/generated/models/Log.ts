...
import { LogMetadataFromJSON, LogMetadataFromJSONTyped, LogMetadataToJSON, LogMetadataToJSONTyped } from './LogMetadata';
...
export function LogFromJSONTyped(json: any, ignoreDiscriminator: boolean): Log {
  ...
  return {
    ...
    metadata: LogMetadataFromJSON(json['metadata']),
  };
}
...
export function LogToJSONTyped(value?: Log | null, ignoreDiscriminator: boolean = false): any {
  ...
  return {
    ...
    metadata: LogMetadataToJSON(value['metadata']),
  };
}
