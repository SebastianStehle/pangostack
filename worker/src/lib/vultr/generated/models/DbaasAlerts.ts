 ...
 * @export
 * @interface DbaasAlerts
 */
export interface DbaasAlerts {
  /**
   * The date and time in which the alert was sent.
   * @type {string}
   * @memberof DbaasAlerts
   */
  timestamp?: string;
  /**
...
/**
 * Check if a given object implements the DbaasAlerts interface.
 */
export function instanceOfDbaasAlerts(value: object): value is DbaasAlerts {
  return true;
}

export function DbaasAlertsFromJSON(json: any): DbaasAlerts {
  return DbaasAlertsFromJSONTyped(json, false);
}

export function DbaasAlertsFromJSONTyped(json: any, ignoreDiscriminator: boolean): DbaasAlerts {
  if (json == null) {
    return json;
  }
  return {
    ...
    maintenanceScheduled: json['maintenance_scheduled'] == null ? undefined : json['maintenance_scheduled'],
    resourceType: json['resource_type'] == null ? undefined : json['resource_type'],
    tableCount: json['table_count'] == null ? undefined : json['table_count'],
  };
}

export function DbaasAlertsToJSON(json: any): DbaasAlerts {
  return DbaasAlertsToJSONTyped(json, false);
}

export function DbaasAlertsToJSONTyped(value?: DbaasAlerts | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
  ...
  return {
    ...
    maintenance_scheduled: value['maintenanceScheduled'],
