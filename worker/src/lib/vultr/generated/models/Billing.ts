 ...
 */
export function instanceOfBilling(value: object): value is Billing {
  return true;
}
...
export function BillingToJSON(json: any): Billing {
  return BillingToJSONTyped(json, false);
}

export function BillingToJSONTyped(value?: Billing | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
