 ...
 *
 * @export
 * @interface CreatePushzoneRequest
 */
export interface CreatePushzoneRequest {
  /**
   * The user-supplied label.
   * @type {string}
   * @memberof CreatePushzoneRequest
   */
  label: string;
  /**
...
/**
 * Check if a given object implements the CreatePushzoneRequest interface.
 */
export function instanceOfCreatePushzoneRequest(value: object): value is CreatePushzoneRequest {
  if (!('label' in value) || value['label'] === undefined) return false;
  return true;
}

export function CreatePushzoneRequestFromJSON(json: any): CreatePushzoneRequest {
  return CreatePushzoneRequestFromJSONTyped(json, false);
}

export function CreatePushzoneRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreatePushzoneRequest {
  if (json == null) {
    return json;
  }
  return {
...
export function CreatePushzoneRequestToJSON(json: any): CreatePushzoneRequest {
  return CreatePushzoneRequestToJSONTyped(json, false);
}

export function CreatePushzoneRequestToJSONTyped(value?: CreatePushzoneRequest | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
