 ...
 *
 * @export
 * @interface UpdateBaremetalRequest
 */
export interface UpdateBaremetalRequest {
   ...
   * @type {string}
   * @memberof UpdateBaremetalRequest
   */
  userData?: string;
  /**
...
/**
 * Check if a given object implements the UpdateBaremetalRequest interface.
 */
export function instanceOfUpdateBaremetalRequest(value: object): value is UpdateBaremetalRequest {
  return true;
}

export function UpdateBaremetalRequestFromJSON(json: any): UpdateBaremetalRequest {
  return UpdateBaremetalRequestFromJSONTyped(json, false);
}

export function UpdateBaremetalRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateBaremetalRequest {
  if (json == null) {
    return json;
  }
  return {
...
export function UpdateBaremetalRequestToJSON(json: any): UpdateBaremetalRequest {
  return UpdateBaremetalRequestToJSONTyped(json, false);
}

export function UpdateBaremetalRequestToJSONTyped(value?: UpdateBaremetalRequest | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
