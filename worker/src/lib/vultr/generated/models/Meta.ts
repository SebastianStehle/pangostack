...
import type { MetaLinks } from './MetaLinks';
import { MetaLinksFromJSON, MetaLinksFromJSONTyped, MetaLinksToJSON, MetaLinksToJSONTyped } from './MetaLinks';
...
export function MetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): Meta {
  ...
  return {
    ...
    links: json['links'] == null ? undefined : MetaLinksFromJSON(json['links']),
  };
}
...
export function MetaToJSONTyped(value?: Meta | null, ignoreDiscriminator: boolean = false): any {
  ...
  return {
    total: value['total'],
    links: MetaLinksToJSON(value['links']),
  };
}
