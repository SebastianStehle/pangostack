 ...
 *
 * @export
 * @interface UpdatePushzoneRequest
 */
export interface UpdatePushzoneRequest {
  /**
   * The user-supplied label.
   * @type {string}
   * @memberof UpdatePushzoneRequest
   */
  label?: string;
  /**
...
/**
 * Check if a given object implements the UpdatePushzoneRequest interface.
 */
export function instanceOfUpdatePushzoneRequest(value: object): value is UpdatePushzoneRequest {
  return true;
}

export function UpdatePushzoneRequestFromJSON(json: any): UpdatePushzoneRequest {
  return UpdatePushzoneRequestFromJSONTyped(json, false);
}

export function UpdatePushzoneRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdatePushzoneRequest {
  if (json == null) {
    return json;
  }
  return {
...
export function UpdatePushzoneRequestToJSON(json: any): UpdatePushzoneRequest {
  return UpdatePushzoneRequestToJSONTyped(json, false);
}

export function UpdatePushzoneRequestToJSONTyped(value?: UpdatePushzoneRequest | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
