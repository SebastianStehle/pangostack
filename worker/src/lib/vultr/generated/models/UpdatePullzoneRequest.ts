 ...
 *
 * @export
 * @interface UpdatePullzoneRequest
 */
export interface UpdatePullzoneRequest {
  /**
   * The user-supplied label.
   * @type {string}
   * @memberof UpdatePullzoneRequest
   */
  label?: string;
  /**
...
/**
 * Check if a given object implements the UpdatePullzoneRequest interface.
 */
export function instanceOfUpdatePullzoneRequest(value: object): value is UpdatePullzoneRequest {
  return true;
}

export function UpdatePullzoneRequestFromJSON(json: any): UpdatePullzoneRequest {
  return UpdatePullzoneRequestFromJSONTyped(json, false);
}

export function UpdatePullzoneRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdatePullzoneRequest {
  if (json == null) {
    return json;
  }
  return {
...
export function UpdatePullzoneRequestToJSON(json: any): UpdatePullzoneRequest {
  return UpdatePullzoneRequestToJSONTyped(json, false);
}

export function UpdatePullzoneRequestToJSONTyped(value?: UpdatePullzoneRequest | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
