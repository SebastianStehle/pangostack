 ...
 * @export
 * @interface BaremetalGet
 */
export interface BaremetalGet {
  /**
   * A unique ID for the Bare Metal instance.
   * @type {string}
   * @memberof BaremetalGet
   */
  id?: string;
  /**
...
/**
 * Check if a given object implements the BaremetalGet interface.
 */
export function instanceOfBaremetalGet(value: object): value is BaremetalGet {
  return true;
}

export function BaremetalGetFromJSON(json: any): BaremetalGet {
  return BaremetalGetFromJSONTyped(json, false);
}

export function BaremetalGetFromJSONTyped(json: any, ignoreDiscriminator: boolean): BaremetalGet {
  if (json == null) {
    return json;
  }
  return {
...
export function BaremetalGetToJSON(json: any): BaremetalGet {
  return BaremetalGetToJSONTyped(json, false);
}

export function BaremetalGetToJSONTyped(value?: BaremetalGet | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
