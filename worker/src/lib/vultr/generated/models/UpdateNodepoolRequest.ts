...
/**
 * Check if a given object implements the UpdateNodepoolRequest interface.
 */
export function instanceOfUpdateNodepoolRequest(value: object): value is UpdateNodepoolRequest {
  return true;
}

export function UpdateNodepoolRequestFromJSON(json: any): UpdateNodepoolRequest {
  return UpdateNodepoolRequestFromJSONTyped(json, false);
}

export function UpdateNodepoolRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateNodepoolRequest {
  if (json == null) {
    return json;
  }
  return {
...
export function UpdateNodepoolRequestToJSON(json: any): UpdateNodepoolRequest {
  return UpdateNodepoolRequestToJSONTyped(json, false);
}

export function UpdateNodepoolRequestToJSONTyped(value?: UpdateNodepoolRequest | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
