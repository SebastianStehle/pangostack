...
export function SubaccountToJSON(json: any): Subaccount {
  return SubaccountToJSONTyped(json, false);
}

export function SubaccountToJSONTyped(value?: Subaccount | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
