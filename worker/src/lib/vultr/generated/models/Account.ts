...
export function AccountFromJSONTyped(json: any, ignoreDiscriminator: boolean): Account {
  ...
  return {
    ...
    lastPaymentDate: json['last_payment_date'] == null ? undefined : json['last_payment_date'],
    lastPaymentAmount: json['last_payment_amount'] == null ? undefined : json['last_payment_amount'],
  };
}
...
export function AccountToJSONTyped(value?: Account | null, ignoreDiscriminator: boolean = false): any {
  ...
  return {
    ...
    last_payment_date: value['lastPaymentDate'],
    last_payment_amount: value['lastPaymentAmount'],
  };
}
