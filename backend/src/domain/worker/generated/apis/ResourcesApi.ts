...
import type { ErrorResponseDto } from '../models/index';
import { ErrorResponseDtoFromJSON, ErrorResponseDtoToJSON } from '../models/index';
...
export class ResourcesApi extends runtime.BaseAPI {
  ...
  async getResourceRaw(
    ...
    if (requestParameters['type'] == null) {
      throw new runtime.RequiredError('type', 'Required parameter "type" was null or undefined when calling getResource().');
    }
