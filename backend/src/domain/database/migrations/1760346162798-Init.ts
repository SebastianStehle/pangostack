...
export class Init1760346162798 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "service-versions" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "definition" text NOT NULL, "definitionSource" text, "environment" text NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "serviceId" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_dc0f7a9c856ab50894f7705796d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
