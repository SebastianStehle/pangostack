...
export interface VerifyResourceRequest {
    resourceRequestDto: ResourceRequestDto;
}
...
export class DeploymentApi extends runtime.BaseAPI {
     ...
     * 
     */
    async verifyResourceRaw(requestParameters: VerifyResourceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['resourceRequestDto'] == null) {
            throw new runtime.RequiredError(
                'resourceRequestDto',
                'Required parameter "resourceRequestDto" was null or undefined when calling verifyResource().'
            );
        }
     ...
     * 
     */
    async verifyResource(resourceRequestDto: ResourceRequestDto, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.verifyResourceRaw({ resourceRequestDto: resourceRequestDto }, initOverrides);
    }
